...
#Mail id : ganjisreeram@gmail.com
#Mobile  : 09490069235
#=================================
...
basepath=`pwd`
#basepath='/home/ishwarchy/kaldi_work/egs/timit/KWS'
...
build-lm.sh -i $basepath/data/$train_folder/lm_train.txt -n $n_gram -o $basepath/data/local/tmp_$train_lang/lm_phone_bg.ilm.gz
